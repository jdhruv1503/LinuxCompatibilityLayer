 ...
 *
 * NOTE: Customer symbols are checked FIRST to allow overriding libc/espidf symbols.
 * This is needed for the Linux compatibility layer to intercept printf/puts etc.
 */
